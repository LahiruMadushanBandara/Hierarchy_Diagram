...
export class DataService {
  ...
  private _originalData: data[] = [
    ...
    { "Id": 24, "Type": 4, "ParentNodeId": 1, "Title": "Other Node", "Header": "riskExpand", "Color": "#3399cc", htmlTemplate: "<div>Agreed process for staff to anonymously raise concerns about workplacr practices</div>" },
    ...
    { "Id": 28, "Type": 4, "ParentNodeId": 1, "Title": "Other Node", "Header": "riskExpand", "Color": "#3399cc", htmlTemplate: "<div>Agreed process for staff to anonymously raise concerns about workplacr practices</div>" },
    ...
    { "Id": 33, "Type": 4, "ParentNodeId": 1, "Title": "Other Node", "Header": "riskExpand", "Color": "#3399cc", htmlTemplate: "<div>Agreed process for staff to anonymously raise concerns about workplacr practices</div>" },
