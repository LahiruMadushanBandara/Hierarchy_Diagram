...
export class ChartComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    function createDiagram() {
       ...
       +"</div>"
        ...
        +"<div class='risk-card-body'>"
          +"<div class='row' style='display:flex;'>"
           + "<div style='background-color:blue; width:50%;''><p>rating1</p></div>"
      ...
      var controlTemplate = "<div class='control-card-content'>"
      ...
      function visualTemplate(options:any) {
        ...
        var renderElement = $("<div style='display:inline-block'; border:solid />").appendTo("body");
        ...
        draw.drawDOM(renderElement, options)
          .then(function(group) {
